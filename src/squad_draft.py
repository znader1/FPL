...
def _apply_player_knowledge(proj, gws, by_id):
    """Thin alias — the implementation now lives in player_knowledge so the
    transfer paths can share it."""
    return player_knowledge.apply_to_projections(proj, gws, by_id)
